...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-nzdo8mu.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-nzdo8mu.containers.anotherwebservice.com/
...
```
git clone git@github.com:Bakacje2019/container-nzdo8mu.git
cd container-nzdo8mu
```
...
```
docker attach container-nzdo8mu
```
